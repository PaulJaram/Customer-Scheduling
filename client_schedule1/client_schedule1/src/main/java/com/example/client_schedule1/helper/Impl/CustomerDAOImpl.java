...
public class CustomerDAOImpl implements CustomerDAO {
    /**This gets a customer from the database.
     * @param id the ID of the customer that is being grabbed from the database
    ...
    /**This gets a list of all customers from a table.
     * @return all customers from a table*/
    @Override
    ...
    /**This inserts a Customer in the database.
    ...
    /**This updates a customer in the database.
